...
mkdir ../data/wrongDepth1
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html ../data/wrongDepth1 abc
echo

echo "testing: out of bound maxdepth"
mkdir ../data/wrongDepth2
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html ../data/wrongDepth2 20
echo
